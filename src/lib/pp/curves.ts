...
const autogeneratedCurve: Curve = {
    id: 'autogen',
    name: 'Automatically Generated Curve (next?)',
    points: [
        [1, 4.727222569345836],
...
export const curves = [duhhelRamenV6Curve, autogeneratedCurve, duhhelRamenV5Curve, fernCurve];
